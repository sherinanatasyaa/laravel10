                        ...
                        <table class="table-auto w-full text-left">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border-r text-center">Description</th>
                                    <th class="px-4 py-2 border-r text-center">Aksi</th>
                                </tr>
                            </thead>
                            @foreach($Groups as $groups)
                            <tbody class="text-gray-600">
                                    <th class="px-4 py-2 border-r text-center"> {{ $loop->iteration }}</th>
                                    <th class="px-4 py-2 border-r text-center"> <a href="/groups/showmember/{{ $groups['id' ] }}"> {{ $groups['name'] }} </a></th>
                                    <th class="px-4 py-2 border-r text-center"> {{ $groups['description'] }}</th>
                                    <th class="px-4 py-2 border-r text-center"><a href="/groups/showaddmember/{{ $groups['id'] }}"> Tambah Anggota Group </a></th>
                                </tbody>
                                @endforeach
                        </table>
                    </div>
