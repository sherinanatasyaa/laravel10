            ...
            <div class="card mt-6">
                ...
                <div class="card-body grid grid-cols-2 gap-6 lg:grid-cols-1">
                    ...
                    <div class="card col-span-2 xl:col-span-1">
                        <div class="card-header text-center">List Friends</div>
                        ...
                        <table class="table-auto w-full text-left">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border-r text-center">No Telepon</th>
                                    <th class="px-4 py-2 border-r text-center">Alamat</th>
                                    <th class="px-4 py-2 border-r text-center">Pendidikan</th>
                                </tr>
                            </thead>
                            @foreach($Friends as $friend)
                            <tbody class="text-gray-600">
                                    <th class="px-4 py-2 border-r text-center"> {{ $loop->iteration }}</th>
                                    <th class="px-4 py-2 border-r text-center"> <a href="/friends/show/{{ $friend['id'] }}"> {{ $friend['nama'] }} </a></th>
                                    <th class="px-4 py-2 border-r text-center"> {{ $friend['no_telp'] }}</th>
                                    <th class="px-4 py-2 border-r text-center"> {{ $friend['alamat'] }}</th>
                                    <th class="px-4 py-2 border-r text-center"> {{ $friend['pendidikan'] }}</th>
                                </tbody>
                                @endforeach
                        </table>
                    </div>
