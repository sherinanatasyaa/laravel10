...
<body class="bg-gray-100">
    ...
    <div
        ...
        <div class="flex-none w-56 flex flex-row items-center">
            <img src="dashboard/dist/img/logo.png" class="w-10 flex-none">
                ...
                <div class="dropdown relative md:static">
                    ...
                    <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                        <div class="w-8 h-8 overflow-hidden rounded-full">
                            <img class="w-full h-full object-cover" src="dashboard/dist/img/user.svg">
                        </div>
                ...
                <div class="card bg-teal-400 border-teal-400 shadow-md text-white">
                    <div class="card-body flex flex-row">
                        ...
                        <div class="img-wrapper w-40 h-40 flex justify-center items-center">
                            <img src="dashboard/dist/img/happy.svg" alt="img title">
                        </div>
                        <!-- end image -->

                        <!-- info -->
                        <div class="py-2 ml-10">
                            <h1 class="h6 text-center">Welcome, {{ $user->name }}</h1>
                            <p class="text-white text-xs text-center">Kamu berada didashboard utama.</p>
                        </div>
                        <!-- end info -->
                        ...
                        <table class="table-auto w-full text-left">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border-r text-center">Nama</th>
                                    <th class="px-4 py-2 border-r text-center">Email</th>
                                    <th class="px-4 py-2 text-center">Registration</th>
                                </tr>
                            </thead>
                            <tbody class="text-gray-600">
                            @foreach($User as $user)
                            <tr>
                                <td class="px-4 py-2 border-r text-center">{{$loop->iteration}}</td>
                                <td class="px-4 py-2 border-r text-center">{{ $user['name'] }}</td>
                                <td class="px-4 py-2 border-r text-center">{{ $user['email'] }}</td>
                                <td class="px-4 py-2 border-r text-center">{{ $user['created_at'] }}</td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
